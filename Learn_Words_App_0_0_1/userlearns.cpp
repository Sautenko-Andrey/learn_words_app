    ...
    , ui(new Ui::UserLearns)
{
    ...
    //     get_all_words_query.exec("SELECT lower(eng_word), rus_word FROM ENG_RUS_WORDS");
    //     // Set language flag
    //     DrawLangLabel(ui->current_languageLabel, "eng_flag.png");
    // }
    // else{
    //     get_all_words_query.exec("SELECT lower(swe_word), rus_word FROM SWE_RUS_WORDS");
    ...
    if(get_all_words_query.exec("SELECT lower(eng_word), rus_word FROM ENG_RUS_WORDS")){
        DrawLangLabel(ui->current_languageLabel, "eng_flag.png");
    }
...
// UserLearns::UserLearns(ChangeLessonMode *changeLessonMode, QWidget *parent)
//     : QDialog(parent)
//     , ui(new Ui::UserLearns)
// {
//     ui->setupUi(this);
...
//     ListWidget *list_widget = new ListWidget(&changeLessonMode, this);
//     list_widget->show();
// }
